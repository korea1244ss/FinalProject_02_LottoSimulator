package kr.uk.dh.finalproject_02_lottosimulator;
...
import kr.uk.dh.finalproject_02_lottosimulator.databinding.ActivityMainBinding;
...
public class MainActivity extends BaseActivity {
    ...
    int[] myLottoNumaArr = { 8, 5, 12,2 , 15};
...
//            1~45의 숫자를 랜덤으로 뽑고
//            중복이 아니라면 => 당첨번호로 선정.
//            만약에 중복이라면? => 다시 뽑자. => 중복이 아닐때까지 계속 뽑자.

            while (true) {

//               1 <= (int)  Math.random() *45 +1 ) <45 +1) < 46

//                1~45의 정수를 랜덤으로 뽑아서 임시저장.
//                이 숫자가 중복검사를 통과하면 사용, 아니면 다시.
                int randomNum = (int) (Math.random() * 45 +1 );

//                중복검사? 당첨번호 전부오 randomNum을 비교.
//                하나라도 같으면 탈락.
